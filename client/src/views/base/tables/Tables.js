...
const Tables = () => {
  ...
  // * Ini useEffect untuk mereload halaman dan fetch data dari database
  // * Trigger nya si useState visible line 26
  // * Jadi si useState visible ini buat buka tutup modal nya
  useEffect(() => {
    axios
                ...
                <CTableBody>
                  {products?.map((p, i) => (
                    <CTableRow key={i}>
                      ...
                      <CTableDataCell>{p.uom}</CTableDataCell>
                      <CTableDataCell>
                        <CButton
                          color="danger"
                        ...
                        <CModal visible={visible} onClose={() => setVisible(false)}>
                          ...
                          <CModalBody>
                            ...
                            <p className="mb-0">Product Name : {p.name}</p>
                            <p>Code : {p.code}</p>
                          </CModalBody>
                          <CModalFooter>
                            <CButton
